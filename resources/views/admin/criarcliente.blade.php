    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a><i class="fa fa-cog"> Gerenciar Clientes</i></a>
                <li class="active"><a href="#"><i class="fa fa-plus-circle"></i> {{ isset($usuario) ? 'Alterar': 'Adicionar' }} Clientes</a></li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">{{isset($usuario) ? 'Alterar': 'Criar'}} Cliente</h3>
                        </div>
                        <!-- /.box-header -->
                        <form action="{{ URL('admin/cliente') }}{{ isset($usuario) ? '/'.$usuario->id : '' }}" method="POST" enctype="multipart/form-data">
                            <div class="box-body">
                                <div class="col-lg-6">
                                    ...
                                    <strong>{{ $errors->first('name') }}</strong>
                                        ...
                                        <input type="text" id="cpf" placeholder="CPF" class="form-control" name="cpf" value="{{ isset($usuario) ? $usuario->cpf : ''  }}" {{ isset($usuario) ? 'disabled' : 'required'  }} autofocus>
