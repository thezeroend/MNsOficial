...
<head>
    ...
    <title>Marinas CMS 1.0| Login</title>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="{{ asset('PainelAdmin/plugins/iCheck/square/blue.css') }}">
    ...
    <div class="login-box-body">
        ...
        <form class="form-horizontal" method="POST" action="{{ route('login') }}">
            ...
            <div class="form-group has-feedback">
                <input id="usuario" type="text" placeholder="Usuario" class="form-control" name="usuario" value="{{ old('usuario') }}" required autofocus>
...
<!-- iCheck -->
<script src="{{ asset('PainelAdmin/plugins/iCheck/icheck.min.js') }}"></script>
<script>
    $(function () {
        $('input').iCheck({
